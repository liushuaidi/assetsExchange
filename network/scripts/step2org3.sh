...
# channel previously setup in the tutorial and install the
...
CC_SRC_PATH="github.com/chaincode/assetsExchange/go/"
if [ "$LANGUAGE" = "node" ]; then
	CC_SRC_PATH="/opt/gopath/src/github.com/chaincode/assetsExchange/node/"
fi
...
echo "Installing chaincode V2.0 on peer0.org3..."
installChaincode 0 3 2.0

echo
echo "========= Org3 is now halfway onto the network ========= "
echo
